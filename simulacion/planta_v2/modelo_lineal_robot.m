function [A, B, M2] = modelo_lineal_robot(P, l0)
%MODELO_LINEAL_ROBOT  Modelo lineal [x phi dx dphi] con entrada tau_w (par total de rueda).
%   Rodadura sin deslizar, reductor rigido (rotor reflejado), pata fija en l0, piso horizontal.
%   M2(1,1) es la masa aparente de la base: incluye la inercia del rotor reflejada al piso.

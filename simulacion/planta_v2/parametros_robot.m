function P = parametros_robot(variante, varargin)
%PARAMETROS_ROBOT  Unica fuente de parametros del robot (SI internamente). Version v2: agrega el
%   contacto rueda-piso, el perfil de escalones y el flexor opcional de la pata.
%   P = parametros_robot('cad')         robot tal como esta en el CAD primera_iteracion
...
%   Los argumentos se dan en mm / g / grados; P queda en SI. Ver tambien parametros_simulink.
  ...
  P.chasis.yc = 0.021; P.chasis.alto = 0.1045;
  P.m.total = 0;
  K = barrido_pata(P, 121);
  if ~K.ok, error('parametros_robot: el cuatro barras no cierra en todo el recorrido'); end
  P.cinematica = K;
  ...
  % ---------- rueda, contacto, piso, flexor ----------
  P.rueda.b_w = o.b_w; P.rueda.mu = o.mu; P.rueda.v_s = o.v_s; P.rueda.c_v = o.c_v;
  P.contacto.k = o.k_contacto; P.contacto.c = o.c_contacto;
  P.piso.x0 = o.piso_x0; P.piso.alto = o.piso_alto; P.piso.ancho = o.piso_ancho; P.piso.n = o.piso_n;
  P.flexor.activo = logical(o.flexor); P.flexor.k = o.k_flexor; P.flexor.c = o.c_flexor; P.flexor.carrera = o.carrera_flexor*mm;
  % ---------- motor, bateria, servo, cuerpo, sensores, control ----------
  ...
  P.ctrl.k_comp = o.k_comp; P.ctrl.fc_vel = o.fc_vel; P.ctrl.umbral_vuelo = o.umbral_vuelo;

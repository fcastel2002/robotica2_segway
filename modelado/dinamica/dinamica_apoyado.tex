...
necesita el servo: es el que tiene la masa de verdad, porque la cabina pesa cuatro veces más que la rueda.
...
\midrule
\(AB\) & bancada, del eje del servo \(A\) al pivote \(B\). 100 mm, inclinada \(45^\circ\) \\
\(AD\) & manivela, la que mueve el servo. 140 mm \\
\(BC\) & balancín. 135 mm \\
\(CD\) & lado del acoplador que va a \(C\). 51 mm \\
\(DP\) & lado del acoplador que va al eje de la rueda \(P\). 140 mm \\
...
\midrule
\(m_{AD},\,m_{BC},\,m_{CDP}\) & masa de la manivela, del balancín y del acoplador. 29, 7 y 19.5 g \\
\(m_P\) & rueda más motor, que cuelgan de \(P\). 125 g \\
\(m_c\) & masa de la cabina, o sea todo lo que no es pata. 671 g \\
...
\end{align}
El más grande es \(c_P\) (el del eje de la rueda): en \(\theta=25^\circ\) mide 249 mm/rad, o sea que por cada
radián que gira el servo la rueda se aleja 249 mm de la cabina. Panel (b) de la figura.
...
término, el de la cabina, es casi el 90 por ciento del total.
...
\textbf{En \(K\)} & \\
\midrule
Entró la cabina & \(\tfrac12(m_c/n)|c_P|^2\dot\theta^2\). Es el término más grande, casi el 90 por ciento de
...
\midrule
Altura de la cabina \(h\) [mm] & 79.5 & 151.6 & 213.2 \\
\(\beta'\), \(\psi'\) [rad/rad] & \(-0.703\), \(1.260\) & \(-0.950\), \(0.964\) & \(-1.161\), \(1.120\) \\
\(|c_P|=|y_P'|\) [mm/rad] & 312 & 249 & 227 \\
\(I_{eq}\) [g\,m\(^2\)] & 35.51 & 22.55 & 19.07 \\
\(\tau_{est}=U'\) [kg\,cm] & 11.62 & 9.23 & 8.44 \\
\midrule
...
La postura más exigente es la plegada: ahí el brazo \(|c_P|\) es máximo y el servo tiene que dar 11.6 kg\,cm
solo para sostener el robot quieto, contra los 21 kg\,cm del DS3225MG. La inercia también es máxima ahí, casi
...
Las masas y las inercias son estimaciones del CAD, y las cuatro fricciones son cero. Los dos pendientes de
...
\item \texttt{dinamica\_pata.m}: sección 1 los parámetros, para editar; sección 2 los tres casos; sección 3 una
  ...
  la caída de un escalón. El caso de este documento se elige con la cadena \texttt{'parado'}.

...
| `dinamica/` | `dinamica_pata.m`: sección 1 parámetros editables, sección 2 los tres casos, sección 3 simulación de agacharse y pararse con ode45, sección 4 verificación contra el DCL. `dinamica_resumen.pdf`, `fig_dinamica.png` (el mecanismo con todos los ángulos) y `fig_casos.png` (los tres casos) | Torque estático; masas y centros de masa; simulación mínima ejecutable; gráficos |
